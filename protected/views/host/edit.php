<div class="location">修改主机</div>

<form action="<?php echo $r; ?>host/edit" method="post" name="addform">
<table class="bd_c_1" cellpadding="0" cellspacing="0">
		<tr><label><?php echo $msgHost;?></label></tr>
		<tr>
			<td><label>主机IP:</label><input type="text" name="ip" value="<?php echo $rsInfo['ip'];?>" size=30/></td>
		</tr>
		<tr>
