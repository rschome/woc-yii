<div class="location">修改数据库</div>

<form action="<?php echo $r; ?>data/edit" method="post" name="addform">
<table class="bd_c_1" cellpadding="0" cellspacing="0">
		<tr><label><?php echo $msgData;?></label></tr>
		<tr>
			<td><label>数据库名称:</label><input type="text" name="name" value="<?php echo $rsInfo['name'];?>" size=30/></td>
		</tr>
		<tr>
