<div class="location">修改域名</div>

<form action="<?php echo $r; ?>domain/edit" method="post" name="addform">
<table class="bd_c_1" cellpadding="0" cellspacing="0">
		<tr><label><?php echo $msgDomain;?></label></tr>
		<tr>
			<td><label>域名名称:</label><input type="text" name="name" value="<?php echo $rsInfo['name'];?>" size=30/></td>
		</tr>
		<tr>
