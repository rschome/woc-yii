...
<div class="massaction"><a href="<?php echo $r; ?>email/add">添加</a></div>
...
<?php if($i%2 == 0):?>
	<tr bgcolor="#F6F6F6">
		...
		<td><a target="_blank" href="<?php echo 'http://'.$item->admin ?>">管理</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo $r; ?>email/edit/id/<?php echo $item->id ?>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo $r; ?>email/delete/id/<?php echo $item->id ?>">删除</a></td>
	</tr>
<?php else:?>
	<tr>
		<td><?php echo $item->id ?></td>
